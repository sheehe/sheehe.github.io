...
})({"lfun5":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "451fc9f88738a4f9";
"use strict";
...
},{}],"kcO6d":[function(require,module,exports,__globalThis) {
...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    const masterTimeline = (0, _gsap.gsap).timeline({
        defaults: {
            duration: 0.8,
            ease: "power2.out"
        },
    ...
    (0, _gsap.gsap).from(".about-section", {
        opacity: 0,
        y: 60,
        duration: 1,
        ease: "power2.out",
    ...
    (0, _gsap.gsap).from(".latest-guides-section h2", {
        opacity: 0,
        x: -60,
        duration: 0.8,
        ease: "power2.out",
    ...
    (0, _gsap.gsap).from(".guide-list li", {
        opacity: 0,
        y: 20,
        duration: 0.6,
        ease: "power2.out",
...
},{"./gsap-core.js":"evdHe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["lfun5","kcO6d"], "kcO6d", "parcelRequire2fc1", {})

//# sourceMappingURL=sheehe.github.io.8738a4f9.js.map
